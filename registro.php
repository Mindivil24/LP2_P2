...
<form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
    ...
    <input type="password" name="password_confirm" placeholder="Ingrese password" required><br>
...
if(!empty($_POST)){
        ...
        if(strlen($password)<8){
          echo"<p>las contraseñas debe tener al menos 8 caracteres";
          $errores++;
        ...
        echo "<div style='color:red'>ha ocurrido un error</div>";

    }catch(Exception $e){
        echo "<div style='color:red'>ha ocurrido una exception</div>";
